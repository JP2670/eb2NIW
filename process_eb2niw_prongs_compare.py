...
end_line = 100  # <-- Change here: ending line number (inclusive)

# Your petition details hardcoded
my_case = {
    "Prong1": "Strong: direct tie to public safety, federal funding, U.S. infrastructure",
    "Prong2": "6+ years professional work, named in projects, backed by VPs",
    "Prong3": "Clear urgency, delay = risk to public safety and federal deadlines"
}
